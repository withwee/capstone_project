    ...
    <div class="dashboard-cards">
        ...
        <div class="card shadow-sm border-0" style="border-radius:12px; background:#ffc107; color:#fff;">
            <div class="card-body text-center" style="padding:1.25rem;">
                ...
                <span class="btn btn-light btn-sm" style="color:#ffc107; font-weight:600; border-radius:8px;"><?php echo e(__('common.More_info')); ?> <i class="fas fa-arrow-circle-right ml-1"></i></span>
            </div>
        </div>
    </div>
