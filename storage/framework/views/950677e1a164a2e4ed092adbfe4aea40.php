...
">
    ...
    <div style="display:flex; align-items:center;">
        <h1 style="margin:0; font-size:1.25rem; font-weight:600; color:#fff;">
            <i class="fas fa-home mr-2"></i> <?php echo $__env->yieldContent('content-header', 'Dashboard'); ?>
        </h1>
    </div>
    ...
    <ul class="navbar-nav ml-auto" style="display:flex; align-items:center; gap:1.5rem; margin:0;">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" style="color:#fff;">
                <i class="fas fa-user-circle"></i> <?php echo e(auth()->user()->getFullname()); ?>
...
<?php /**PATH D:\laragon\www\pos-capstone\resources\views/layouts/partials/navbar.blade.php ENDPATH**/ ?>